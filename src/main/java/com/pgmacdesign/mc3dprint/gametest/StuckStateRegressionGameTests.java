...
public class StuckStateRegressionGameTests {
    ...
    public static void collapseResetsModeAndStatusButKeepsRf(GameTestHelper helper) {
        ...
        helper.runAfterDelay(60, () -> {
            ...
            int storedRf = printer.getCapability(net.minecraftforge.common.capabilities.ForgeCapabilities.ENERGY)
            ...
            st.getBlock().playerWillDestroy(helper.getLevel(), abs, st, helper.makeMockSurvivalPlayer());
