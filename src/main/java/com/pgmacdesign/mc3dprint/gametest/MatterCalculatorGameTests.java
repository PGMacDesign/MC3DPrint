...
public class MatterCalculatorGameTests {
    ...
    public static void predictedCostMatchesConsumed(GameTestHelper helper) {
        ...
        net.minecraftforge.energy.IEnergyStorage energyStore = printer
                .getCapability(net.minecraftforge.common.capabilities.ForgeCapabilities.ENERGY)
                .orElseThrow(() -> new GameTestAssertException("printer has no energy capability"));
        int energyBefore = energyStore.getEnergyStored();
        ...
        helper.succeedWhen(() -> {
            ...
            int consumedRf = energyBefore - energyStore.getEnergyStored();
