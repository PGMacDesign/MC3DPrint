...
public class TerminalQueueGameTests {
    ...
    private static void forceMachineOnEveryRequest(CompoundTag saved) {
        net.minecraft.nbt.ListTag list = saved.getList("Requests", net.minecraft.nbt.Tag.TAG_COMPOUND);
        for (int i = 0; i < list.size(); i++) {
            list.getCompound(i).put("Machine", net.minecraft.nbt.NbtUtils.writeBlockPos(MACHINE_A));
        }
    }
}
