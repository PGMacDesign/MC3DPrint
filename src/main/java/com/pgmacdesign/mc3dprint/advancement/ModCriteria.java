...
public final class ModCriteria {
     ...
     */
    public static final BasicTrigger T7_FORMED = new BasicTrigger(id("t7_formed"));
    public static final BasicTrigger T8_FORMED = new BasicTrigger(id("t8_formed"));
    ...
    public static void register() {
        ...
        CriteriaTriggers.register(T7_FORMED);
        CriteriaTriggers.register(T8_FORMED);
    }
