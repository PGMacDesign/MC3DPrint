...
- **Q13 — Ore Salting (T3-only, confirmed).** A placed natural-stone block has a chance to come
  ...
  - **Hosts (broadened 2026-07-04):** all **solid full-cube stone variants**, grouped by
    ...
    chiseled, smooth_stone, andesite/diorite/granite+polished, tuff family, calcite,
    ...
    palette pre-scan). The 1.21+ tuff building blocks aren't in 1.20.1, so the legacy
    backport lists only plain `tuff`.
